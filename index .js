// ==================== FIREBASE CONFIG ====================
// firebaseConfig waxa lagu daah-furay faylka "firebase-config.js"
// (eeg <script src="firebase-config.js"> ee index.html ee kahor index.js)
...
async function sendImageMessage(base64) {
    ...
    try {
        const storageRef = storage.ref(`chatImages/${Date.now()}.jpg`);
...
async function sendVoiceMessage(blob) {
    ...
    try {
        const storageRef = storage.ref(`voiceMessages/${Date.now()}.webm`);
